from random import randint # Gerar valores interiros randomicos aleatórios

class Calcular:
    
    def __init__(self: object, dificuldade: int, / ) -> None: # Argumento posicional /
        self.__dificuldade: int = dificuldade
        self.__valor1: int = self._gerar_valor 
        self.__valor2: int = self._gerar_valor
        self.__operacao: int = randint(1, 3) # numero aleatorio entre 1 e 3
    ...
    def _gerar_valor(self: object) -> int:
        if self.dificuldade == 1:
            return randint(0, 10) # entre 0 e 10
    ...
    def mostar_operacao(self: object) -> None:
